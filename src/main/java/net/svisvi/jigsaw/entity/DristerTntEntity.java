...
public class DristerTntEntity extends PathfinderMob {
	public DristerTntEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(JigsawModEntities.DRISTER_TNT.get(), world);
	}

	public DristerTntEntity(EntityType<DristerTntEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
