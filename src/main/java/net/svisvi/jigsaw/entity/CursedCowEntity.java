...
public class CursedCowEntity extends Cow {
	public CursedCowEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(JigsawModEntities.CURSED_COW.get(), world);
	}

	public CursedCowEntity(EntityType<CursedCowEntity> type, Level world) {
		super(type, world);
		xpReward = 2;
		setNoAi(false);
	}
