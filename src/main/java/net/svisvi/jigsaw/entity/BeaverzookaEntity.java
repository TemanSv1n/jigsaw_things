...
import net.svisvi.jigsaw.procedures.BeaverzookaWhileProjectileFlyingTickProcedure;
...
public class BeaverzookaEntity extends AbstractArrow implements ItemSupplier {
	public BeaverzookaEntity(PlayMessages.SpawnEntity packet, Level world) {
		super(JigsawModEntities.BEAVERZOOKA.get(), world);
	}
	...
	public ItemStack getItem() {
		return new ItemStack(JigsawModBlocks.BEAVERBLOCK.get());
	}

	@Override
	protected ItemStack getPickupItem() {
		return new ItemStack(JigsawModItems.BEAVERAMMO.get());
	}
	...
	public void tick() {
		super.tick();
		BeaverzookaWhileProjectileFlyingTickProcedure.execute(this.level, this.getX(), this.getY(), this.getZ(), this);
		if (this.inGround)
			this.discard();
	}
	...
	public static BeaverzookaEntity shoot(Level world, LivingEntity entity, Random random, float power, double damage, int knockback) {
		BeaverzookaEntity entityarrow = new BeaverzookaEntity(JigsawModEntities.BEAVERZOOKA.get(), entity, world);
	...
	public static BeaverzookaEntity shoot(LivingEntity entity, LivingEntity target) {
		BeaverzookaEntity entityarrow = new BeaverzookaEntity(JigsawModEntities.BEAVERZOOKA.get(), entity, entity.level);
