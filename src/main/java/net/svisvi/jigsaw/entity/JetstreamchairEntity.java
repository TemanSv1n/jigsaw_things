...
import net.svisvi.jigsaw.procedures.JetstreamchairOnEntityTickUpdateProcedure;
...
public class JetstreamchairEntity extends Monster {
	public JetstreamchairEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(JigsawModEntities.JETSTREAMCHAIR.get(), world);
	}

	public JetstreamchairEntity(EntityType<JetstreamchairEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
	...
	public void baseTick() {
		super.baseTick();
		JetstreamchairOnEntityTickUpdateProcedure.execute(this.level, this.getX(), this.getY(), this.getZ(), this);
	}
