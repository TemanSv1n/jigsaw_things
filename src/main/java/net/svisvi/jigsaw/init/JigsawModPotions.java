...
public class JigsawModPotions {
	...
	public static final RegistryObject<Potion> PURGATIVESTRONG = REGISTRY.register("purgativestrong", () -> new Potion(new MobEffectInstance(JigsawModMobEffects.PURGATIVE.get(), 20, 0, false, true)));
