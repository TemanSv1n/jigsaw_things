...
public class PurgenammogunItem extends Item {
	public PurgenammogunItem() {
	...
	public void releaseUsing(ItemStack itemstack, Level world, LivingEntity entityLiving, int timeLeft) {
		if (!world.isClientSide() && entityLiving instanceof ServerPlayer entity) {
			...
			if (PurgenammogunCanUseRangedItemProcedure.execute(entity)) {
				PurgenammogunEntity entityarrow = PurgenammogunEntity.shoot(world, entity, world.getRandom(), 1f, 5, 5);
