...
import net.svisvi.jigsaw.init.JigsawModFeatures;
...
public class JigsawMod {
	public static final Logger LOGGER = LogManager.getLogger(JigsawMod.class);
	public static final String MODID = "jigsaw";
	...
	public JigsawMod() {
		...
		JigsawModMobEffects.REGISTRY.register(bus);
		JigsawModPotions.REGISTRY.register(bus);

		JigsawModParticleTypes.REGISTRY.register(bus);
	}
