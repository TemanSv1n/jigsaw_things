...
public class ShitTntDispenseOnDispenseAttemptWithResultProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z, Direction direction) {
		...
		if (world instanceof ServerLevel _level) {
			...
			entityToSpawn.moveTo((direction.getStepX()), (direction.getStepY()), (direction.getStepZ()), world.getRandom().nextFloat() * 360F, 0);
