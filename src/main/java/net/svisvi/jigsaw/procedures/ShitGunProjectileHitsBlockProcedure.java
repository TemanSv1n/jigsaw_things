...
public class ShitGunProjectileHitsBlockProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z, Entity entity, Entity immediatesourceentity) {
		...
		if (world instanceof ServerLevel _level)
			_level.sendParticles(ParticleTypes.LAVA, x, (y + 0.5), z, 30, 1.5, 0.7, 3, 0);
		{
			...
			for (Entity entityiterator : _entfound) {
				entityiterator.hurt((new IndirectEntityDamageSource("arrow", immediatesourceentity, entity)), 6);
