...
public class Modelpoop_smoke_grenade_entity<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "poop_smoke_grenade_entity"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition group = partdefinition.addOrReplaceChild("group",
				CubeListBuilder.create().texOffs(21, 2).mirror()
						.addBox(-1.0F, -3.6938F, -0.9562F, 2.0F, 10.0F, 2.0F, new CubeDeformation(0.0F)).mirror(false)
						.texOffs(4, 17).addBox(-1.0F, -6.6938F, -0.9562F, 2.0F, 3.0F, 2.0F, new CubeDeformation(0.0F))
						.texOffs(0, 0).addBox(0.25F, 1.0562F, -1.2062F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F))
						.texOffs(0, 0).addBox(0.25F, -1.1938F, -1.2062F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F))
						.texOffs(8, 0).addBox(-1.25F, -1.1938F, 0.2938F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F))
						.texOffs(8, 0).addBox(-1.25F, 1.0562F, 0.2938F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F))
						.texOffs(8, 0).addBox(-1.25F, -1.1938F, -2.4562F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F))
						.texOffs(8, 0).addBox(-1.25F, 1.0562F, -2.4562F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F))
						.texOffs(3, 0).addBox(-2.5F, -1.1938F, -1.2062F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F))
						.texOffs(3, 0).addBox(-2.5F, 1.0562F, -1.2062F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, 17.6938F, -0.0438F));

		PartDefinition cube_r1 = group.addOrReplaceChild("cube_r1",
				CubeListBuilder.create().texOffs(3, 0).addBox(-1.0F, -1.0F, -1.25F, 2.0F, 2.0F, 2.0F,
		...
		PartDefinition cube_r2 = group.addOrReplaceChild("cube_r2",
				CubeListBuilder.create().texOffs(8, 0).addBox(-1.25F, -1.0F, -1.0F, 2.0F, 2.0F, 2.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r7 = group.addOrReplaceChild("cube_r7",
				CubeListBuilder.create().texOffs(0, 0).addBox(-1.0F, -1.0F, -1.25F, 2.0F, 2.0F, 2.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(1.25F, -2.4438F, 0.0438F, 0.0F, 0.0F, -0.3927F));
		...
		PartDefinition cube_r9 = group.addOrReplaceChild("cube_r9",
				CubeListBuilder.create().texOffs(5, 17).addBox(-1.0F, -1.25F, -1.25F, 2.0F, 2.0F, 1.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r10 = group.addOrReplaceChild("cube_r10",
				CubeListBuilder.create().texOffs(3, 18).addBox(-1.0F, 0.0F, -0.5F, 2.0F, 1.0F, 1.0F,
						new CubeDeformation(0.0F)),
