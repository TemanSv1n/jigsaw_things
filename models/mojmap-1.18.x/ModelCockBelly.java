...
public class ModelCockBelly<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "cockbelly"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition Body2 = Body.addOrReplaceChild("Body2",
				CubeListBuilder.create().texOffs(43, 51)
						.addBox(-3.0F, 4.0F, -6.0F, 6.0F, 8.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(43, 51)
						.addBox(-3.0F, 3.0F, -5.0F, 6.0F, 1.0F, 3.0F, new CubeDeformation(0.0F)).texOffs(47, 53)
						.addBox(3.0F, 4.0F, -4.0F, 1.0F, 8.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(47, 53)
